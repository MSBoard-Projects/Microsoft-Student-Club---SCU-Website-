...
test('members retain their stable ID and certificate when updated', async () => {
  ...
  await waitFor(() => expect(membersApi.update).toHaveBeenCalledWith(4, expect.objectContaining({ publicId: 'student', memberTypeId: 4, certificateUrl: '/club-certificates/student.pdf' })));
});
