    ...
    <footer className="club-footer">
      <div className="club-container">
        <div className="club-footer-top">
          ...
          <nav aria-label="Footer navigation"><Link to="/">Home</Link><Link to="/events">Events</Link><Link to="/gallery">Gallery</Link><Link to="/members">Members</Link><Link to="/leadership">Leadership</Link><Link to="/golden-members">Golden Honours</Link><Link to="/achievements">Achievements</Link></nav>
